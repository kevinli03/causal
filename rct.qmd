...
$$
Y_i = \alpha + D_i\tau_\text{ATE} + \varepsilon_i
$$
...
$$
X_i = \alpha +  D_i\beta + \varepsilon_i
$$
...
$$
Y_{ijk} = \alpha + \underbrace{D_{ijk, \ell} \tau_\text{AMCE} + D_{ijk, \text{not }\ell}\gamma}_{\text{categorical variables}} + \varepsilon_{ijk}
$$
